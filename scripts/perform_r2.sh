...
#echo "Executing the Jupyter Notebook..."
#jupyter nbconvert --to notebook --execute ${NOTEBOOK_PATH}/${NOTEBOOK_NAME}.ipynb --output ${NOTEBOOK_PATH}/${NOTEBOOK_NAME}_out.ipynb
#echo "Executing the Jupyter Notebook Done!"
# copy the model onnx file to conversion scripts network folder
